...
- **ESP32** - ✅ Full support with WiFi auto-management
- **ESP32-S2** - ✅ Full support
- **ESP32-C3** - ✅ Full support  
- **ESP32-S3** - ✅ Full support
- **ESP8266** - ✅ Compatible (limited memory)
- **Raspberry Pi Pico W** - ⚠️ Basic support
- **Other MicroPython boards** - ⚠️ Limited support

## 📦 Installation for MicroBlock
